// Invoke-Portscan Task Handler
// The operator CLI reads Invoke-Portscan.ps1, appends the invocation with -Hosts and -Ports args,
...
export class TaskHandler {
  ...
  getTask = async function (req, res) {
    ...
    const display      = `PS: Invoke-Portscan`
