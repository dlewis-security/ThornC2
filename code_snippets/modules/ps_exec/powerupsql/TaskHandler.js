// PowerUpSQL Task Handler
// The operator CLI reads PowerUpSQL.ps1, appends Get-SQLInstanceDomain | Get-SQLServerInfo,
...
export class TaskHandler {
  ...
  getTask = async function (req, res) {
    ...
    const display      = `PS: PowerUpSQL (Get-SQLInstanceDomain)`
