// SharpHound Task Handler
// The operator CLI reads Sharphound.ps1, appends Invoke-BloodHound with collection args,
// UTF-16LE base64 encodes the script, and stores the full
// 'powershell -w hidden -ep bypass -EncodedCommand <b64>' string as 'command'.
// After completion, the CLI automatically downloads the output zip.
export class TaskHandler {
  ...
  getTask = async function (req, res) {
    ...
    const display      = `PS: Invoke-BloodHound (SharpHound)`
