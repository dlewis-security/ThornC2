...
//
// Used together with peb_walk.rs to resolve LoadLibraryA and GetProcAddress
// without having them in the import table. After these two are resolved,
// everything else can be resolved the "normal" dynamic way via dynload.rs.
...
pub unsafe fn get_proc_by_hash(base: *const u8, hash: u32) -> *mut u8 {
    ...
    // OptionalHeader at nt+4+20 = nt+24; DataDirectory at +112
